       ...
       <v-container fluid pa-0 ma-0>
           <v-layout justify-center column>
               <v-flex>
                   <v-layout align-center justify-space-between>
                       ...
                       <v-flex xs4>
                           <v-layout class="py-5" justify-center justify-space-around>
                               <v-btn @click.sync="termsDialog = true" text class="white--text">
                                   Terms of use
                               </v-btn>
                           </v-layout>
                       </v-flex>
                       <v-flex xs4>
                           <v-layout justify-center>
                               <v-btn :href="contact.url" targer="_blank" class="mx-2" color="white" v-for="(contact, i) in contacts" :key="i" icon>
           ...
           <v-layout justify-center>
               <v-dialog v-model="termsDialog" width="600px">
                   <v-card>
                       <v-card-title>
                           <span class="mx-auto headline">Terms of use</span>
                       </v-card-title>
    ...
    export default {
        ...
        data: () => ({
            ...
            contacts: [
                ...
                {
                    icon: 'mdi-linkedin',
                    url: 'https://www.linkedin.com/in/bogdan-alyabyev-77b54418a/'
                },
                {
                    icon: 'mdi-instagram',
                    url: 'https://www.instagram.com/mczoff/'
                }
            ]
        })
    }
